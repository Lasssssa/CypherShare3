          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                CypherShare lets you share encrypted files with verified World
                ID users — instantly, privately, and decentralized on Filecoin.
              </p>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="text-center">
                  <p className="text-muted-foreground text-sm">
                    Your files, encrypted and delivered securely to verified
                    World ID users
                  </p>
                </div>
              </CardContent>
      ...
      <footer className="border-t border-border bg-card/50 backdrop-blur-md mt-24">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-muted-foreground text-sm">
              © 2024 CypherShare. Secure file sharing with World ID
              verification.
            </p>
          </div>
        </div>
